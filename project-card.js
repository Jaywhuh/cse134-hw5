...
class ProjectCard extends HTMLElement {
        ...
        this.shadowRoot.innerHTML += `
            <div class="card">
                ...
                <picture>
                    ...
                    <source id="image-jpeg" media="(max-width: 768px)" type="image/jpeg">
                    <img id="thumbnail" src="images/default.jpg" alt="Project Image">
                </picture>
    ...
    set projectData(data) {
        ...
        this.shadowRoot.querySelector("#image-jpeg").srcset = data.imageJpeg || "images/default-m.jpg";
        this.shadowRoot.querySelector("#thumbnail").src = data.image || "images/default.jpg";
